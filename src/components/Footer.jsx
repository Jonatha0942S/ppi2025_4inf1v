    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.meunome}>
                <p>Jonathas Roberto de Souza</p>
            </div>
            <div className={styles.icons}>
                <a href="https://github.com/Jonatha0942S" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://br.linkedin.com/in/jonathas-roberto-4174b41b9?trk=public_profile_samename-profile" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://instagram.com/_jona.thas" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
